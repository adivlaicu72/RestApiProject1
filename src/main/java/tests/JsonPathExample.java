...
public class JsonPathExample {
	...
	public void testJsonPath() {
		...
		List<String> listOfIdFemales = json.getList("users.findAll{it.gender == 'f'}._id");
		System.out.println(listOfIdFemales);
		System.out.println(listOfIdFemales.size());
		System.out.println(listOfIdFemales.get(0));
		System.out.println("-----------------------------------------------");
		...
		System.out.println(allMalesCaps.size());*/
		...
		System.out.println(allUsersWithUnknownGender.size());
		System.out.println("-----------------------------------------------");
